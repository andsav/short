...
fn main() {
    ...
    */
    ...
    if args.len() != 5 {
        helpers::abort("Expects arguments: <router_id>, <nse_hostname>, <nse_port>, <router_port>");
    }
    ...
    let nse_port: u16 = args[3].parse::<u16>().expect("Invalid router_port");
    let router_port: u16 = args[4].parse::<u16>().expect("Invalid nse_port");
    ...
    */
    macro_rules! udp_send {
        ($packet: expr) => {
            ...
            let log_msg = s_router_name + " sent " + &*pkt.log_message() + "\n";
